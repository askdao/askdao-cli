...
| `detected_mcp_configs` | `DetectMCPConfigs` | project `.mcp.json` + user scope(claude `~/.claude.json` / cowork app-data) + type=url 兼容标记 |
